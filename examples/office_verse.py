...
async def run():
    ...
    await drone.offboard.set_position_ned(
            PositionNedYaw(4.4, 0.0, -0.9, 0.0))
    await asyncio.sleep(10)

    print("-- Go 1m North, 0m East, -1m Down \
            within local coordinate system, turn to face East")
    await drone.offboard.set_position_ned(
            PositionNedYaw(4.4, 0.0, -0.9, 90.0))
    await asyncio.sleep(8)

    print("-- Go 1m North, 1m East, -1m Down \
            within local coordinate system")
    await drone.offboard.set_position_ned(
            PositionNedYaw(4.4, 2.9, -0.9, 90.0))
    await asyncio.sleep(8)

    print("-- Go 0m North, 1m East, -1m Down \
            within local coordinate system, turn to face South")
    await drone.offboard.set_position_ned(
            PositionNedYaw(6.0, 5.0, -0.9, 60.0))
    await asyncio.sleep(10)
    
    print("-- Go 0m North, 0m East, -1m Down \
            within local coordinate system, turn to face South")
    await drone.offboard.set_position_ned(
            PositionNedYaw(10.1, 5.0, -0.9, 0))
    await asyncio.sleep(10)
    
    print("-- Go 0m North, 0m East, 0m Down \
            within local coordinate system, turn to face South")
    await drone.offboard.set_position_ned(
            PositionNedYaw(11.9, 6.6, -0.9, 45))
    await asyncio.sleep(10)

    print("-- Go 0m North, 0m East, 0m Down \
            within local coordinate system, turn to face South")
    await drone.offboard.set_position_ned(
            PositionNedYaw(11.9, 6.6, -0.9, 90))
    await asyncio.sleep(4)

    print("-- Go 0m North, 0m East, 0m Down \
            within local coordinate system, turn to face South")
    await drone.offboard.set_position_ned(
            PositionNedYaw(12.3, 10.0, -0.9, 90.0))
    await asyncio.sleep(10)

    print("-- Go 0m North, 0m East, 0m Down \
            within local coordinate system, turn to face South")
    await drone.offboard.set_position_ned(
            PositionNedYaw(12.7, 13.0, -0.9, 90.0))
    await asyncio.sleep(10)
